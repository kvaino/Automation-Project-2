class IssueModal {
  ...
  getCommentArea() {
    return cy.get(this.commentArea);
  }

  writeCommentToIssue(comment) {
    cy.get(this.commentArea).type(comment);
  }

  clickSaveButtonAndValidateItDoesNotExistAfterUse() {
  ...
  clickEditButtonAndValidateItDoesNotExistAfterUse() {
    cy.contains("button", this.editButtonName).click().should("not.exist");
  }

  confirmIssueCommentDeletion() {
